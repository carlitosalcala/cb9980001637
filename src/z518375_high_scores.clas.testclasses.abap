...
CLASS ltcl_high_scores IMPLEMENTATION.
  ...
  METHOD test_list_of_scores.
    DATA(input_values) = VALUE z518375_high_scores=>integertab( ( 30 ) ( 50 ) ( 20 ) ( 70 ) ).
    DATA(cut) = NEW z518375_high_scores( input_values ).
    DATA(expected_values) = VALUE z518375_high_scores=>integertab( ( 30 ) ( 50 ) ( 20 ) ( 70 ) ).
  ...
  METHOD test_latest_score.
    DATA(input_values) = VALUE z518375_high_scores=>integertab( ( 100 ) ( 0 ) ( 90 ) ( 30 ) ).
    DATA(cut) = NEW z518375_high_scores( input_values ).
    cl_abap_unit_assert=>assert_equals(
      act = cut->latest( )
      exp = 30 ).
  ...
  METHOD test_personal_best.
    DATA(input_values) = VALUE z518375_high_scores=>integertab( ( 40 ) ( 100 ) ( 70 ) ).
    DATA(cut) = NEW z518375_high_scores( input_values ).
    cl_abap_unit_assert=>assert_equals(
  ...
  METHOD test_personal_top_three.
    DATA(input_values) = VALUE z518375_high_scores=>integertab( ( 10 ) ( 30 ) ( 90 ) ( 30 ) ( 100 ) ( 20 ) ( 10 )
                                                             ( 0 ) ( 30 ) ( 40 ) ( 40 ) ( 40 ) ( 70 ) ( 70 ) ).
    DATA(cut) = NEW z518375_high_scores( input_values ).
    DATA(expected_values) = VALUE z518375_high_scores=>integertab( ( 100 ) ( 90 ) ( 70 ) ).
    cl_abap_unit_assert=>assert_equals(
 ...
 "Personal top highest to lowest
  METHOD test_personal_highest_to_low.
    DATA(input_values) = VALUE z518375_high_scores=>integertab( ( 20 ) ( 10 ) ( 30 ) ).
    DATA(cut) = NEW z518375_high_scores( input_values ).
    DATA(expected_values) = VALUE z518375_high_scores=>integertab( ( 30 ) ( 20 ) ( 10 ) ).
    cl_abap_unit_assert=>assert_equals(
      act = cut->personaltopthree( )
      exp = expected_values ).
  ENDMETHOD.
  ...
  METHOD test_personal_top_tie.
    DATA(input_values) = VALUE z518375_high_scores=>integertab( ( 40 ) ( 20 ) ( 40 ) ( 30 ) ).
    DATA(cut) = NEW z518375_high_scores( input_values ).
    DATA(expected_values) = VALUE z518375_high_scores=>integertab( ( 40 ) ( 40 ) ( 30 ) ).
    cl_abap_unit_assert=>assert_equals(
      act = cut->personaltopthree( )
      exp = expected_values ).
  ENDMETHOD.
  ...
  METHOD test_personal_top_less_3.
    DATA(input_values) = VALUE z518375_high_scores=>integertab( ( 30 ) ( 70 ) ).
    DATA(cut) = NEW z518375_high_scores( input_values ).
    DATA(expected_values) = VALUE z518375_high_scores=>integertab( ( 70 ) ( 30 ) ).
    cl_abap_unit_assert=>assert_equals(
      act = cut->personaltopthree( )
      exp = expected_values ).
  ENDMETHOD.
  ...
  METHOD test_personal_top_only_1.
    DATA(input_values) = VALUE z518375_high_scores=>integertab( ( 40 ) ).
    DATA(cut) = NEW z518375_high_scores( input_values ).
    DATA(expected_values) = VALUE z518375_high_scores=>integertab( ( 40 ) ).
